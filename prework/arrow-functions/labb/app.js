...
console.log(joe);
//Uncaught TypeError: Student is not a constructor at app.js:166.
...
// the joe Student object.
// 2. What is "this" when joe.scopeArrow() is invoked?
// the Window object (global object) or browser window.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own this. so it will think we refer to window as our function is created in window.
